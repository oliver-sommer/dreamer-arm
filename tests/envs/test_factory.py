...
from dreamer_arm.envs import factory
from dreamer_arm.envs.arms import ArmConfig
from dreamer_arm.envs.factory import _resolve_task_assignments, make_vector_env
...
def test_build_from_config_forwards_arm_tuning(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with initialize_config_dir(config_dir=str(get_config_root()), version_base=None):
        cfg = compose(
            ...
            overrides=["envs=metaworld", "envs.task=door-open", "envs.arm.damping=0.3"],
        )
